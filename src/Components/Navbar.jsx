...
const Navbar = () => {
  ...
  return (
    <nav className="fixed w-full z-10 ">
      <div className="w-full bg-neutral-900 h-20 flex justify-between items-center text-white px-6 md:px-10 font-sans">
        <a href='/' >
      ...
      <div
        className={`lg:hidden fixed bg-neutral-900 text-white h-full w-60 top-20 ease-in-out duration-700 text-center ${
